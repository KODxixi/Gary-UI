...
版本与用途见 [适配器许可清单](adapters/visual/LICENSES.md)，完整原始许可、NOTICE、版本与哈希见 [licenses/third-party](licenses/third-party/)。生成物中内联的运行库同样受各自许可约束。第三方品牌标识可能另有署名、商标与用途限制，不纳入 Gary-UI 原创 MIT 授权。
